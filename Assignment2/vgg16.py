...
num_classes = 10
image_size = 224  # VGG16 input requirement
...
vgg16_base = VGG16(include_top=False, weights=None, input_shape=(224, 224, 3))
...
my_new_model.compile(optimizer=keras.optimizers.Adam(learning_rate=0.01), loss='categorical_crossentropy', metrics=['accuracy'])
